     ...
     return (
          <div className="min-h-screen bg-white text-neutral-900 flex flex-col relative transition-colors duration-300">
               ...
               <div className="flex flex-1 relative">
                    <aside
                         className={`
                              fixed inset-y-0 left-0 z-40 w-64 border-r border-neutral-200 bg-white/95 backdrop-blur-md pt-24 px-4
                              transition-transform duration-300
                              md:sticky md:top-20 md:z-0 md:h-[calc(100vh-5rem)] md:translate-x-0 md:bg-white md:pt-6
